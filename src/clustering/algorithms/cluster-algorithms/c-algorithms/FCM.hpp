	...
	namespace ClusteringAlgorithms {
		namespace CMeansCollection {
			...
			public:
				...
				FCM(double* data, Parameters* algorithm_parameters, function<double(double*, double*, unsigned int, unsigned int)> distance)	
				{
				...
				void GetResult(double* result) const
				{
					copy(ResultMatrix,
						ResultMatrix + sizeof(double)*AlgorithmParameters->CountOfClusters*AlgorithmParameters->CountOfObjects,
						result);
